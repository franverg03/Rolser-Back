...
<body class="contenedor">
    ...
    <div class="contenedor-principal-administrativo">
        ...
        <div class="contenedor-breadcrump-administrativo">
            <div class="maquetacion-breadcrump-administrativo flex flex-row">
                ...
                <a class="estilo-breadcrump-administrativo" href="{{ route('administrativo.pedidos') }}">Pedidos</a>
            </div>
        </div>
        {{-- Contenedor crud datatable paginacion --}}
        <div>
            {{-- CRUD Comerciales --}}
            <div id="crudPedido" class="mt-10">
                <div class="flex flex-row justify-center">
                    {{-- Modificar --}}
                    <button id="mostrarModalModificarPedido" class="botonEliminar">Modificar pedido<svg
                    ...
                    {{-- Eliminar --}}
                    <button id="mostrarConfirmacionEliminarPedido" class="botonEliminar">Deshabilitar comercial<svg
    ...
    <div id="modalConfirmacionEliminarPedido" class="fixed inset-0 z-10 hidden" aria-labelledby="modal-title"
            ...
            <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                <div
                    ...
                    <div class=" btnCaja flex flex-row">
                        <button id="ocultarConfirmacionCancelarPedido" class="cancelConfi w-[50%]">Cancelar</button>
                        <button id="ocultarConfirmacionConfirmarPedido"
    ...
    {{-- Modal modificar --}}
    <div id="modalModificarPedido" class="fixed inset-0 z-10 hidden" aria-labelledby="modal-title" role="dialog"
        aria-modal="true">
        <!-- Fondo oscuro -->
        <div class="fixed inset-0 bg-black/50 transition-opacity blur-effect"></div>
        <!-- Contenedor del modal -->
            ...
            <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                ...
                <div
                    ...
                    <div class="cabeceraModalModificar flex flex-row justify-between">
                        ...
                        <svg class="hoverX" id="ocultarModificarCancelarPedido" width="55" height="55"
                    ...
                    <div class="flex flex-row mt-4">
                        <button id="mostrarModalConfirmacionGuardarPedido"
    ...
    <div id="modalConfirmacionGuardarCambiosPedido" class="fixed inset-0 z-10 hidden" aria-labelledby="modal-title"
        role="dialog" aria-modal="true">
        <!-- Fondo oscuro -->
        <div class="fixed inset-0 bg-black/50 transition-opacity blur-effect"></div>
        <!-- Contenedor del modal -->
        <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
            <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                <div
                    ...
                    <div class=" btnCaja flex flex-row">
                        <button id="cancelarModalConfirmacionGuardarPedido"
                            class="cancelConfi w-[50%]">Cancelar</button>
                        <button id="confirmarModalConfirmacionGuardarPedido"
                            class="confirmConfi w-[50%]">Confirmar</button>
                    </div>
                </div>
            </div>
