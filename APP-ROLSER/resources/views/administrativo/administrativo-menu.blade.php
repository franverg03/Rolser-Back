<div class="menu-administrativo flex">
    ...
    <div class="menu-grande-administrativo" id="menu-grande-administrativo">
        ...
        <div class="div-menu-grande-administrativo">
            <a href="{{ route('administrativo.home') }}" class="{{ request()->routeIs('administrativo.home') ? 'boton-menu-sel-administrativo' : 'boton-menu-noSel-administrativo' }}">Home</a>
            <a href="{{ route('administrativo.clientes') }}" class="{{ request()->routeIs('administrativo.clientes') ? 'boton-menu-sel-administrativo' : 'boton-menu-noSel-administrativo' }}">Clientes</a>
            <a href="{{ route('administrativo.usuarios') }}" class="{{ request()->routeIs('administrativo.usuarios') ? 'boton-menu-sel-administrativo' : 'boton-menu-noSel-administrativo' }}">Usuarios</a>
            <a href="{{ route('administrativo.pedidos') }}" class="{{ request()->routeIs('administrativo.pedidos') ? 'boton-menu-sel-administrativo' : 'boton-menu-noSel-administrativo' }}">Pedidos</a>
            ...
            <a href="{{ route('administrativo.almacenes') }}" class="{{ request()->routeIs('administrativo.almacenes') ? 'boton-menu-sel-administrativo' : 'boton-menu-noSel-administrativo' }}">Almacenes</a>
            <a href="{{ route('administrativo.descuentos') }}"
                class="{{ request()->routeIs('administrativo.descuentos') ? 'boton-menu-sel-administrativo' : 'boton-menu-noSel-administrativo' }}">Descuentos</a>
            <a href="{{ route('administrativo.tarifas') }}" class="{{ request()->routeIs('administrativo.tarifas') ? 'boton-menu-sel-administrativo' : 'boton-menu-noSel-administrativo' }}">Tarifas</a>
        </div>
