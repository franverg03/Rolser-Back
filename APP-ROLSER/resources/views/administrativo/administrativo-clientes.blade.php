...
<body class="contenedor">
    <div class="menu-administrativo flex">
        <div class="menu-pequenyo-administrativo flex flex-col" id="menu-pequenyo-administrativo">
            ...
            <div class="iconos-usuario-logout-administrativo">
                ...
                <!--LogOut icono-->
                <svg class="icono-logout-administrativo" width="27" height="27" viewBox="0 0 27 27" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path
    ...
    <div class="contenedor-principal-administrativo">
        ...
        <div class="contenedor-breadcrump-administrativo">
            <div class="maquetacion-breadcrump-administrativo flex flex-row">
                ...
                <a class="estilo-breadcrump-administrativo" href="{{ route('administrativo.clientes') }}">Clientes</a>
            </div>
        </div>
        ...
        <div class="flex flex-col justify-center">
            ...
            <div id="crudCliente" class="flex justify-center" >
                <div class="flex flex-row">
                    ...
                    {{-- Eliminar --}}
                    <button id="mostrarConfirmacionEliminar" class="botonEliminar">Eliminar cliente<svg width="24"
                            height="19" viewBox="0 0 24 19" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div id="crudClienteVip" class="hidden">
                <div class="flex flex-row">
                    ...
                    {{-- Modificar --}}
                    <button id="mostrarModalModificarCVip" class="botonEliminar">Modificar cliente VIP <svg width="20"
                            height="20" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M5.95801 1.08594H4.87467C2.16634 1.08594 1.08301 2.16927 1.08301 4.8776V8.1276C1.08301 10.8359 2.16634 11.9193 4.87467 11.9193H8.12467C10.833 11.9193 11.9163 10.8359 11.9163 8.1276V7.04427"
                                stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                ...
                <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                    ...
                    <div
                        ...
                        <div class="cabeceraModalModificar flex flex-row justify-between">
                            ...
                            <svg class="hoverX" id="ocultarModificarCancelarCNoVip" width="55" height="55" viewBox="0 0 35 35"
                        ...
                        <div class="flex flex-col cajaSeccionesModalMod">
                            ...
                            <div class="flex flex-row mt-4">
                                ...
                                <button id="mostrarModalConfirmacionGuardarCNoVip"
                                    class="botonEliminar margen-boton-guardar">Guardar<svg width="24" height="24"
            ...
            <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                ...
                <div
                    ...
                    <div class="cabeceraModalModificar flex flex-row justify-between">
                        ...
                        <svg class="hoverX" id="ocultarAnyadirCancelar" width="55" height="55" viewBox="0 0 35 35"
                            fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M21 21L12 12M12 12L3 3M12 12L21.0001 3M12 12L3 21.0001" stroke="#90242A"
                                stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                    ...
                    <div class="flex flex-col cajaSeccionesModalMod">
                        ...
                        <div class="flex flex-row mt-4">
                            ...
                            <button id="mostrarModalConfirmacionAnyadir"
                                class="botonEliminar margen-boton-anyadir">Añadir cliente<svg width="26" height="28"
                                    viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M4.5 9.69531H13.5" stroke="white" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                    <path d="M9 14.4697V4.92969" stroke="white" stroke-width="2" stroke-linecap="round"
    ...
    <div id="modalConfirmacionAnyadir" class="fixed inset-0 z-10 hidden" aria-labelledby="modal-title" role="dialog"
        aria-modal="true">
        <!-- Fondo oscuro -->
        <div class="fixed inset-0 bg-black/50 transition-opacity blur-effect"></div>
        <!-- Contenedor del modal -->
            ...
            <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                ...
                <div
                    ...
                    <div class="cabeceraModalModificar flex flex-row justify-between">
                        ...
                        <svg class="hoverX" id="ocultarModificarCancelarCVip" width="55" height="55" viewBox="0 0 35 35"
                            fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M21 21L12 12M12 12L3 3M12 12L21.0001 3M12 12L3 21.0001" stroke="#90242A"
                                stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                    ...
                    <div class="flex flex-col cajaSeccionesModalMod">
                        ...
                        <div class="flex flex-row mt-4">
                            ...
                            <button id="mostrarModalConfirmacionGuardarCVip"
                                class="botonEliminar margen-boton-modificar">Guardar<svg width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M9.30957 14.3947L10.8096 15.8174L14.8096 12.0234" stroke="white"
                                        stroke-width="2.1" stroke-linecap="round" stroke-linejoin="round" />
                                    <path
            ...
            <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                ...
                <div
                    ...
                    <div class="cabeceraModalModificar flex flex-row justify-between">
                        ...
                        <svg class="hoverX" id="ocultarAnyadirCancelarCVip" width="55" height="55" viewBox="0 0 35 35"
                            fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M21 21L12 12M12 12L3 3M12 12L21.0001 3M12 12L3 21.0001" stroke="#90242A"
                                stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
