<div>
    <div class="flex items-center justify-between mb-4">
        ...
        <div class="botonSecundarioHidden"></div>
    </div>
            ...
            <table class="w-full text-sm text-left bg-white border-collapse bordeRolser">
                <thead class="text-xs uppercase text-white font-bold sticky top-0 colorFondoTablas">
                    <tr>
                        ...
                        <th scope="col" class="px-4 py-3 text-center">Importe</th>
                        <th scope="col" class="px-4 py-3 text-center">Posibilidad cierre</th>
                        <th scope="col" class="px-4 py-3 text-center">Fecha cierre</th>
                    ...
                    @forelse ($oportunidades as $oportunidad)
                        <tr class="border-b bordeRolser tamanyoCelda">
                            <td wire:click.prevent="abrirModalMostrar({{ $oportunidad->id_oportunidad_venta }})"
                                ...
                                @else
                                    {{ $oportunidad->interaccion && $oportunidad->interaccion->clienteVip ? $oportunidad->interaccion->clienteVip->cliente_empresa : 'Cliente VIP no encontrado' }}
                                @endif
                            </td>
