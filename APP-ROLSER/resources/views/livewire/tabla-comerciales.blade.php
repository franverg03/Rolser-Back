<div>
    <div>
        ...
        <div class="flex items-center justify-between">
            ...
            {{-- Añadir --}}
            <button type="button" class="botonSecundario" wire:click.prevent="abrirModalAnyadir">Añadir Comercial<svg
                    ...
                    <tbody>
                        @forelse ($comerciales as $comercial)
                            <tr class="border-b bordeRolser">
                                <td wire:click.prevent="abrirModalMostrar({{ $comercial->id_comercial }})"
                                    class="px-4 py-3 tipografia-contenido-tabla-administrativo">
                                    {{ $comercial->comercial_nombre }}</td>
                                <td wire:click.prevent="abrirModalMostrar({{ $comercial->id_comercial }})"
                                    class="px-4 py-3 tipografia-contenido-tabla-administrativo">
                                    {{ $comercial->comercial_apellidos }}</td>
                                <td wire:click.prevent="abrirModalMostrar({{ $comercial->id_comercial }})"
                                    class="px4 py-3 tipografia-contenido-tabla-administrativo">
                                    {{ $comercial->comercial_zona }}</td>
                                <td wire:click.prevent="abrirModalMostrar({{ $comercial->id_comercial }})"
                                    class="px-4 py-3 tipografia-contenido-tabla-administrativo">
                                    {{ $comercial->comercial_email }}</td>
                                <td>
                                    <div class="flex flex-row">
                                        <button type="button" id="mostrarModalModificar" class="botonCrud mr-3 mb-2"
                                            wire:click.prevent="abrirModalModificar({{ $comercial->id_comercial }})">Modificar
                                        ...
                                        <button class="botonCrud"
                                            wire:click.prevent="abrirModalEliminar({{ $comercial->id_comercial }})">Eliminar<svg
                        ...
                        <div class="flex flex-col cajaSeccionesModalMod">
                            ...
                            <div class="flex flex-row mt-4">
                                ...
                                <button wire:click.prevent="abrirModalConfirmacionAnyadir" type="button"
                                    class="botonEliminar margen-boton-anyadir">Añadir Comercial<svg width="18"
                    ...
                    <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                        <div
                            ...
                            <div class="cajaTxt mt-4">
                                ...
                                <h4 class="infoConfi">La siguiente acción creará un nuevo comercial.</h4>
                            </div>
                            <div class="btnCaja flex flex-row">
                                <button wire:click.prevent="cerrarModalConfirmacionAnyadir"
                                    id="cancelarModalConfirmacionAnyadirComercial"
                                    class="cancelConfi w-[50%]">Cancelar</button>
                                <button wire:click.prevent="anyadirComercial"
                                    id="confirmarModalConfirmacionAnyadirComercial"
    ...
    @if ($modalModificar)
                        ...
                        <div
                            ...
                            <div class="cabeceraModalModificar flex flex-row justify-between">
                                ...
                                <svg wire:click.prevent="cerrarModalModificar" class="hoverX"
                                    id="ocultarModificarCancelarComercial" width="55" height="55"
                            ...
                            <!-- Sección Datos del Comercial -->
                            <div class="flex flex-col cajaSeccionesModalMod">
                                <div class="flex">
                                    <h5 class="seccionesModalModificar">Datos del Comercial:</h5>
                                </div>
                                <div class="flex flex-row">
                                    <input wire:model="comercial_nombre" type="text" name="nombre"
                                        id="nombre"
                                        class="tamanyoInputMedioModales mr-5 w-full p-2 pr-10 border rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500"
                                        placeholder="Nombre" />
                                    <input wire:model="comercial_apellidos" type="text" id="searchInput"
                            ...
                            <div class="flex flex-col cajaSeccionesModalMod">
                                ...
                                <div class="flex flex-row">
                                    <div class="flex flex-col">
                                        <label for="direccion" class="labelsModal text-start">DNI:</label>
                                        <input wire:model="comercial_dni" type="text" id="searchInput"
                                            class="tamanyoInputMedioGrandeModales mr-5 w-full p-2 pr-10 border rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500"
                                            placeholder="DNI" />
                                    </div>
                                ...
                                <div class="flex flex-row mt-4">
                                    ...
                                    <div class="flex flex-col">
                                        <label for="zona" class="labelsModal text-start">Zona:</label>
                                        <input wire:model="comercial_zona" type="text" id="searchInput"
                                            class="tamanyoInputGrandeModales w-full p-2 pr-10 border rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500"
                                            placeholder="Zona" />
                                    </div>
                                ...
                                <div class="flex flex-row mt-4">
                                    <div class="flex flex-col">
                                        <label for="usuario" class="labelsModal text-start">Usuario:</label>
                                        <input wire:model="id_usuario" type="text" id="searchInput"
                                            class="tamanyoInputMedioGrandeModales mr-5 w-full p-2 pr-10 border rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500"
                                            placeholder="ID Usuario" />
                                    </div>
                                    <button wire:click.prevent="abrirModalConfirmacionModificar"
                                        id="mostrarModalConfirmacionGuardarComercial" type="button"
        ...
        @if ($modalConfirmacionModificar)
            ...
            <div id="modalConfirmacionGuardarCambiosComercial" class="fixed inset-0 z-10"
                        ...
                        <div
                            ...
                            <div class="btnCaja flex flex-row">
                                <button wire:click.prevent="cerrarModalConfirmacionModificar"
                                    id="cancelarModalConfirmacionGuardarComercial" type="button"
                                    class="cancelConfi w-[50%]">
                                    Cancelar
                                </button>
                                <button wire:click.prevent="modificarComercial"
                                    id="confirmarModalConfirmacionGuardarComercial" type="submit"
                ...
                <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                    <div
                        ...
                        <div class="cajaTxt mt-4">
                            ...
                            <h4 class="infoConfi">La siguiente acción eliminará al comercial seleccionado.</h4>
                        </div>
                        <div class="btnCaja flex flex-row">
                            <button wire:click.prevent="cerrarModalEliminar"
                                class="cancelConfi w-[50%]">Cancelar</button>
                            <button wire:click.prevent="eliminarComercial"
                                class="confirmConfi w-[50%]">Confirmar</button>
                        </div>
                    </div>
                </div>
