                ...
                <table class="w-full text-sm text-left bg-white border-collapse bordeRolser tablaComercial">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b bordeRolser tamanyoCelda">
                            <td class="px-4 py-3">
                                <input type="checkbox" value="{{ $clienteVipT->id }}" class="rounded-sm" id="check-cliente" name="clientes-vip">
                            </td>
                            <td class="px-4 py-3">{{ $clienteVipT->cliente_nombre_representante }} {{ $clienteVipT->cliente_apellidos_representante }}</td>
                            <td class="px-4 py-3">{{ $clienteVipT->cliente_empresa }}</td>
                            <td class="px-4 py-3">{{ $clienteVipT->cliente_nif }}</td>
                            <td class="px-4 py-3">{{ $clienteVipT->cliente_telefono_representante }}</td>
                        </tr>
                    @empty
                        <tr>
