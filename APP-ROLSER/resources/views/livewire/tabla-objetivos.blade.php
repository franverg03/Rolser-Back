            ...
            <div class="fixed inset-0 z-20" aria-labelledby="modal-title" role="dialog" aria-modal="true">
                ...
                <div class="fixed inset-0 z-30 w-screen overflow-y-auto">
                    <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                        <div
                            class="relative transform overflow-hidden cajaModalModificarTablet text-center rounded-lg bg-white shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-2xl">
                            <div class="cabeceraModalModificar flex flex-row justify-between">
                                ...
                                <svg wire:click.prevent="cerrarModalMostrar" class="hoverX cursor-pointer"
                            ...
                            <div class="flex flex-col cajaSeccionesModalMod p-6 gap-4">
                                <div class="flex flex-row gap-4">
                                    <div class="flex flex-col flex-1">
                                        ...
                                        <input wire:model="tipo_objetivo" type="text"
                                            class="tamanyoInputGrandeModales w-full p-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500"
                                            readonly />
                                    </div>
                                </div>
                                <div class="flex flex-col">
                                    <label class="labelsModal text-left">Descripción:</label>
                                    <textarea wire:model="descripcion_objetivo"
                                        class="w-[450px] p-2 border bordeRolser rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 resize-none h-24"
                                        readonly></textarea>
                                </div>
                                <div class="flex flex-row gap-4 mt-2">
                                    <div class="flex flex-col">
                                        <label class="labelsModal text-left">Valor Actual:</label>
                                        <input wire:model="valor_actual" type="text"
                                            class="tamanyoInputMedioModales w-full p-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 font-bold"
                                            readonly />
                                    </div>
                                    <div class="flex flex-col">
                                        <label class="labelsModal text-left">Meta a alcanzar:</label>
                                        <input wire:model="valor_meta" type="text"
                                            class="tamanyoInputMedioModales w-full p-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 font-bold text-[#90242A]"
                                            readonly />
                                    </div>
                                </div>
                                <div class="flex flex-row gap-4 mt-2">
                                    <div class="flex flex-col">
                                        ...
                                        <input wire:model="fecha_inicio" type="text"
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <input wire:model="fecha_fin" type="text"
                                            class="tamanyoInputMedioModales w-full p-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500"
                                            readonly />
                                    </div>
                                </div>
                                ...
                                <div class="flex flex-row">
                                    <div class="px-8 py-5">
                                        @php
                                            $porcentaje = $this->calcularProgreso(
                                                $objetivo->valor_actual,
                                                $objetivo->valor_meta,
                                            );
                                        @endphp
                                        <div class="flex justify-between mb-2">
                                            <span class="text-lg font-bold text-gray-700 mr-1">Meta:
                                                {{ $objetivo->valor_actual }} / {{ $objetivo->valor_meta }}</span>
                                            <span class="text-lg font-bold text-[#90242A]">{{ $porcentaje }}%</span>
                                        </div>
                                        <div class="w-full bg-gray-300 rounded-full h-3">
                                            <div class="bg-[#90242A] h-3 rounded-full transition-all duration-500 ease-out"
