                                    ...
                                    <div class="flex flex-row justify-center">
                                        <button type="button" id="mostrarModalModificar" class="botonCrud mr-3 mb-2"
                                            ...
                                            <svg width="17" height="17" viewBox="0 0 24 24" fill="none"
                                                ...
                                                <path d="M12 16L12 3" stroke="white" stroke-width="2"
        ...
        <div class="fixed inset-0 z-10" aria-labelledby="modal-title" role="dialog" aria-modal="true">
            ...
            <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
                <div class="flex min-h-full items-start justify-center p-4 text-center pt-4">
                    <div
                        class="relative transform overflow-hidden rounded-lg bg-white shadow-xl transition-all w-full max-w-[95vw]">
                        <div class="cabeceraModalModificar flex flex-row justify-between items-center p-2">
                            ...
                            <svg wire:click.prevent="cerrarModalMostrar" class="cursor-pointer mr-2" width="35"
                        ...
                        <div class="w-full">
                            <div
                                class="border-4 border-gray-100 rounded-lg h-[85vh] overflow-hidden shadow-inner bg-gray-200">
                ...
                <div
                    ...
                    <div class="flex flex-row mt-4 justify-end mb-4 mr-6">
                        <button wire:click.prevent="enviarCorreo" type="button"
                            class="botonEliminar margen-boton-anyadir">Enviar<svg width="17" height="17"
