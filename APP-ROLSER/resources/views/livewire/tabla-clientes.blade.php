            ...
            <div class="contenedorTablas overflow-hidden rounded-t-lg rounded-b-lg">
                <table class="w-full text-sm text-left bg-white border-collapse bordeRolser">
                    <thead class="text-xs uppercase color-cabecera-tabla-admin text-white font-bold">
                        <tr>
                            <th class="px-4 py-3 border-b bordeRolser tipografia-cabecera-tabla-administrativo">Representante</th>
                            <th class="px-4 py-3 border-b bordeRolser tipografia-cabecera-tabla-administrativo">Empresa</th>
                            <th class="px-4 py-3 border-b bordeRolser tipografia-cabecera-tabla-administrativo">NIF</th>
                            <th class="px-4 py-3 border-b bordeRolser tipografia-cabecera-tabla-administrativo">Contacto</th>
                        </tr>
                    </thead>
                    <tbody>
                        @forelse ($clientesNoVip as $cliente)
