                                ...
                                <td>
                                    <div class="flex flex-row">
                                        <button type="button" id="mostrarModalModificar" class="botonCrud mr-3 mb-2"
                                            wire:click.prevent="abrirModalModificar({{ $administrativo->id_administrativo }})">Modificar
                ...
                <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                    <div
                        ...
                        <div class="cajaTxt mt-4">
                            ...
                            <h4 class="infoConfi">La siguiente acción eliminará al administrativo seleccionado.
                            </h4>
                        </div>
                        <div class=" btnCaja flex flex-row">
