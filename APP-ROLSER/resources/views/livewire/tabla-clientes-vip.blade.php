    ...
    <section class="mt-10 ">
        ...
        <div class="flex items-center justify-between p-4">
            <div class="contenedorTablas overflow-hidden relative">
                ...
                @if ($search)
                    <div class="absolute inset-y-0 right-3 flex items-center cursor-pointer" id=" limpiarInputBuscar" wire:click="clearSearch">
        ...
        <div class="contenedorTablas overflow-hidden rounded-t-lg rounded-b-lg">
            <table class="w-full text-sm text-left bg-white border-collapse bordeRolser ">
                <thead class="text-xs uppercase color-cabecera-tabla-admin text-white font-bold">
                    <tr>
                        <th scope="col"
                            class="px-4 py-3 border-b bordeRolser tipografia-cabecera-tabla-administrativo">
                            Representante</th>
                        <th scope="col"
                            class="px-4 py-3 border-b bordeRolser tipografia-cabecera-tabla-administrativo">Empresa</th>
                        <th scope="col"
                            class="px-4 py-3 border-b bordeRolser tipografia-cabecera-tabla-administrativo">NIF</th>
                        <th scope="col"
                            class="px-4 py-3 border-b bordeRolser tipografia-cabecera-tabla-administrativo">Contacto
                        </th>
                    </tr>
                </thead>
                <tbody>
