<div>
    <div class="flex items-center justify-between mb-4">
        <div class="relative">
            ...
            @if ($search)
                <div class="absolute inset-y-0 right-3 flex items-center cursor-pointer" wire:click.prevent="clearSearch">
        ...
        <button type="button" class="botonSecundario" wire:click.prevent="abrirModalAnyadir">Añadir Interacción
            <svg width="26" height="28" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M4.5 9.69531H13.5" stroke="#af272f" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M9 14.4697V4.92969" stroke="#af272f" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
        </button>
    </div>
            ...
            <tbody>
                @forelse ($interacciones as $interaccion)
                    <tr class="border-b bordeRolser tamanyoCelda">
                        <td wire:click.prevent="abrirModalMostrar({{ $interaccion->id_interaccion }})" class="px-4 py-3 tipografia-contenido-tabla-administrativo">
                        ...
                        <td>
                            <div class="flex flex-row">
                                <button type="button" class="botonCrud mr-3 mb-2" wire:click.prevent="abrirModalModificar({{ $interaccion->id_interaccion }})">
                                    Modificar
                                ...
                                <button class="botonCrud" wire:click.prevent="abrirModalEliminar({{ $interaccion->id_interaccion }})">
                                    Eliminar
                        ...
                        <div class="flex flex-col cajaSeccionesModalMod">
                            <div class="flex flex-row mb-4">
                                <div class="flex flex-col">
                                    ...
                                    <input wire:model="fecha_interaccion" type="text" class="tamanyoInputMedioModales w-full p-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500" readonly />
                                </div>
                                <div class="flex flex-col ml-10">
                                    <label class="labelsModal text-left">Medio contacto:</label>
                                    <input wire:model="medio_contacto" type="text" class="tamanyoInputMedioGrandeModales w-full p-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500" readonly />
                                </div>
                            </div>
                            <div class="flex flex-col mb-4">
                                <label class="labelsModal text-left">Resumen contacto:</label>
                                <input wire:model="resumen_contacto" type="text" class="tamanyoInputExtraGrandeModales w-full p-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500" readonly />
                            </div>
                            <div class="flex flex-row">
                                <div class="flex flex-col">
                                    <label class="labelsModal text-left">Resultado:</label>
                                    <input wire:model="resultado" type="text" class="tamanyoInputMedioModales w-full p-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500" readonly />
                                </div>
                                <div class="flex flex-col ml-10">
                ...
                <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                    <div class="relative transform overflow-hidden cajaModalModificarTablet text-center rounded-lg bg-white shadow-xl transition-all">
                        <div class="cabeceraModalModificar flex flex-row justify-between">
                            ...
                            <svg wire:click.prevent="cerrarModalAnyadir" class="hoverX cursor-pointer" width="55" height="55" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M21 21L12 12M12 12L3 3M12 12L21.0001 3M12 12L3 21.0001" stroke="#90242A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </div>
                        <div class="flex flex-col cajaSeccionesModalMod p-4">
                            <div class="flex flex-row gap-4 mb-4">
                                <div class="flex flex-col">
                                    <label class="labelsModal text-left">Fecha:</label>
                                    <input wire:model="fecha_interaccion" type="date" class="tamanyoInputMedioModales w-full p-2 border rounded-lg  focus:ring-red-500" />
                                </div>
                                <div class="flex flex-col">
                                    <label class="labelsModal text-left">Medio contacto:</label>
                                    <input wire:model="medio_contacto" type="text" class="tamanyoInputGrandeModales w-full p-2 border rounded-lg focus:ring-red-500" placeholder="Medio contacto" />
                                </div>
                            </div>
                            <div class="flex flex-col mb-4">
                                <label class="labelsModal text-left">Resumen contacto:</label>
                                <input wire:model="resumen_contacto" type="text" class="tamanyoInputExtraGrandeModales w-full p-2 border rounded-lg focus:ring-red-500" placeholder="Resumen contacto" />
                            </div>
                            <div class="flex flex-row mb-4">
                                <div class="flex flex-col">
                                    <label class="labelsModal text-left">Resultado:</label>
                                    <select wire:model="resultado" class="tamanyoInputMedioGrandeModales w-full p-2 border rounded-lg focus:ring-red-500 bg-white text-left">
                                ...
                                <div class="flex flex-col ml-5">
                                    ...
                                    <select wire:model.live="id_cliente_vip" class="tamanyoInputMedioGrandeModales w-full p-2 border rounded-lg focus:ring-red-500 bg-white text-left">
                                        <option value="">Selecciona Cliente VIP</option>
                                        @foreach ($clientes_vip as $cliente)
                                            <option value="{{ $cliente->id_cliente_vip ?? $cliente->id_cliente }}">{{ $cliente->cliente_empresa }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="flex flex-col mb-4">
                                ...
                                <select wire:model.live="id_cliente_no_vip" class="tamanyoInputMedioGrandeModales w-full p-2 border rounded-lg focus:ring-red-500 bg-white text-left">
                                    <option value="">Selecciona Cliente No VIP</option>
                                    @foreach ($clientes_no_vip as $cliente)
                                        <option value="{{ $cliente->id_cliente_no_vip ?? $cliente->id_cliente }}">{{ $cliente->cliente_empresa }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="flex flex-row justify-end mr-24">
                                <button wire:click.prevent="anyadirInteraccion" type="button" class="botonEliminar flex items-center justify-center gap-2 px-4 py-2 ">
                                    Añadir
                ...
                <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                    <div class="relative transform overflow-hidden cajaModalModificarTablet text-center rounded-lg bg-white shadow-xl transition-all">
                        <div class="cabeceraModalModificar flex flex-row justify-between">
                            ...
                            <svg wire:click.prevent="cerrarModalAnyadirOportunidad" class="hoverX cursor-pointer" width="55" height="55" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M21 21L12 12M12 12L3 3M12 12L21.0001 3M12 12L3 21.0001" stroke="#90242A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </div>
                        <div class="flex flex-col cajaSeccionesModalMod p-4">
                            <div class="flex flex-row gap-4 mb-4">
                                <div class="flex flex-col flex-1">
                                    ...
                                    <input wire:model="importe_estimado" type="number" step="0.01" class="tamanyoInputMedioModales w-full p-2 border rounded-lg focus:ring-red-500" placeholder="1500.00"/>
                                </div>
                                <div class="flex flex-col flex-1">
                                    <label class="labelsModal text-left">Posibilidad:</label>
                                    <select wire:model="posibilidad" class="tamanyoInputGrandeModales w-full p-2 border rounded-lg focus:ring-red-500 bg-white text-left">
                            ...
                            <div class="flex flex-col mb-4">
                                ...
                                <input wire:model="fecha_cierre_prevista" type="date" class="tamanyoInputExtraGrandeModales w-full p-2 border rounded-lg focus:ring-red-500"/>
                            </div>
                            <div class="flex flex-row justify-end">
                                <button wire:click.prevent="abrirModalConfirmacionAnyadir" type="button" class="botonEliminar flex items-center justify-center gap-2 px-4 py-2">
                                    Añadir Oportunidad
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M9.30957 14.3947L10.8096 15.8174L14.8096 12.0234" stroke="white" stroke-width="2.1" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M10 6.14557H14C16 6.14557H16 5.19707 16 4.24857C16 2.35156 15 2.35156 14 2.35156H10C9 2.35156 8 2.35156 8 4.24857C8 6.14557 9 6.14557 10 6.14557Z" stroke="white" stroke-width="2.1" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M16 4.26562C19.33 4.43635 21 5.60301 21 9.93765V15.6286C21 19.4226 20 21.3196 15 21.3196H9C4 21.3196 3 19.4226 3 15.6286V9.93765C3 5.61249 4.67 4.43635 8 4.26562" stroke="white" stroke-width="2.1" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
                                </button>
                            </div>
                ...
                <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                    <div class="relative transform overflow-hidden cajaConfi text-center w-[25%] rounded-lg bg-white shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                        <div class="cajaTxt mt-4">
                            ...
                            <h4 class="infoConfi">La siguiente acción creará una nueva interacción y una oportunidad.</h4>
                        </div>
                        <div class="btnCaja flex flex-row">
                            <button wire:click.prevent="cerrarModalConfirmacionAnyadir" class="cancelConfi w-[50%]">Cancelar</button>
                            <button wire:click.prevent="guardarOportunidadManual" class="confirmConfi w-[50%]">Confirmar</button>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="relative transform overflow-hidden cajaModalModificarTablet text-center rounded-lg bg-white shadow-xl transition-all">
                        ...
                        <div class="flex flex-col cajaSeccionesModalMod">
                            <div class="flex flex-row mb-4">
                                ...
                                <div class="flex flex-col ml-10">
                                    <label class="labelsModal text-left">Medio contacto:</label>
                                    <input wire:model="medio_contacto" type="text" class="tamanyoInputMedioGrandeModales w-full p-2 border rounded-lg focus:ring-red-500" />
                                </div>
                            </div>
                            <div class="flex flex-col mb-4">
                                <label class="labelsModal text-left">Resumen contacto:</label>
                                <input wire:model="resumen_contacto" type="text" class="tamanyoInputExtraGrandeModales w-full p-2 border rounded-lg focus:ring-red-500" />
                            </div>
                            <div class="flex flex-row mb-4">
                                <div class="flex flex-col">
                                    <label class="labelsModal text-left">Resultado:</label>
                                    <input wire:model="resultado" type="text" class="tamanyoInputMedioModales w-full p-2 border rounded-lg focus:ring-red-500" />
                                </div>
                                <div class="flex flex-col ml-10">
                                    <label class="labelsModal text-left">Empresa:</label>
                                    <input wire:model="nombre_empresa" type="text" class="tamanyoInputMedioGrandeModales w-full p-2 border rounded-lg bg-gray-100" readonly />
                                </div>
                            </div>
                            <div class="flex flex-row justify-end mr-24">
            ...
            <div class="fixed inset-0 z-20 w-screen overflow-y-auto">
                <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                    <div class="relative transform overflow-hidden cajaConfi text-center w-[25%] rounded-lg bg-white shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                        ...
                        <div class="btnCaja flex flex-row">
                            <button wire:click.prevent="cerrarModalConfirmacionModificar" type="button" class="cancelConfi w-[50%]">Cancelar</button>
                            <button wire:click.prevent="modificarInteraccion" type="submit" class="confirmConfi w-[50%]">Confirmar</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
                <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                    <div class="relative transform overflow-hidden cajaConfi text-center w-[25%] rounded-lg bg-white shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                        ...
                        <div class="btnCaja flex flex-row">
                            <button wire:click.prevent="cerrarModalEliminar" class="cancelConfi w-[50%]">Cancelar</button>
                            <button wire:click.prevent="eliminarInteraccion" class="confirmConfi w-[50%]">Confirmar</button>
                        </div>
                    </div>
                </div>
            </div>
