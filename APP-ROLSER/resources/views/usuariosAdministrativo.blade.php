...
<body class="contenedor">
    <div class="menu-administrativo flex">
        ...
        <div class="menu-grande-administrativo" id="menu-grande-administrativo">
            ...
            <div class="div-menu-grande-administrativo">
                <a href="/homeAdministrativo" class="boton-menu-noSel-administrativo"
                ...
                <a href="/productosAdministrativo" class="boton-menu-noSel-administrativo"
                    routerLink="productosAdministrativo">Productos</a>
                <a href="/catalogosAdministrativo" class="boton-menu-noSel-administrativo"
        ...
        <div class="flex flex-col">
            ...
            <div id="crudComerciales">
                <div class="flex flex-row">
                    ...
                    {{-- Modificar --}}
                    <button id="mostrarModalModificarComercial" class="botonEliminar">Modificar comercial<svg
                    ...
                    {{-- Eliminar --}}
                    <button id="mostrarConfirmacionEliminarComercial" class="botonEliminar">Deshabilitar comercial<svg
            ...
            <div id="crudAdministrativos" class="hidden">
                <div class="flex flex-row">
                    ...
                    {{-- Modificar --}}
                    <button id="mostrarModalModificarAdministrativo" class="botonEliminar">Modificar administrativo<svg
                            width="20" height="20" viewBox="0 0 13 13" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M5.95801 1.08594H4.87467C2.16634 1.08594 1.08301 2.16927 1.08301 4.8776V8.1276C1.08301 10.8359 2.16634 11.9193 4.87467 11.9193H8.12467C10.833 11.9193 11.9163 10.8359 11.9163 8.1276V7.04427"
                    ...
                    {{-- Eliminar --}}
                    <button id="mostrarConfirmacionEliminarAdministrativo" class="botonEliminar">Deshabilitar administrativo<svg
                            width="24" height="19" viewBox="0 0 24 19" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path d="M6 9.49219H18" stroke="white" stroke-width="3.5" stroke-linecap="round"
                                stroke-linejoin="round" />
    ...
    <div id="modalConfirmacionEliminarComercial" class="fixed inset-0 z-10 hidden" aria-labelledby="modal-title"
            ...
            <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                <div
                    ...
                    <div class="cajaTxt mt-4">
                        ...
                        <h4 class="infoConfi">La siguiente acción deshabilitará al comercial pero no borrará sus datos.
                        </h4>
                    </div>
                    <div class=" btnCaja flex flex-row">
                        <button id="ocultarConfirmacionCancelarComercial"
                            class="cancelConfi w-[50%]">Cancelar</button>
                        <button id="ocultarConfirmacionConfirmarComercial"
    ...
    {{-- Modal modificar --}}
    <div id="modalModificarComercial" class="fixed inset-0 z-10 hidden" aria-labelledby="modal-title" role="dialog"
        aria-modal="true">
        <!-- Fondo oscuro -->
        <div class="fixed inset-0 bg-black/50 transition-opacity blur-effect"></div>
        <!-- Contenedor del modal -->
        <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
            <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                ...
                <div
                    class="relative transform overflow-hidden cajaModalModificarComercial text-center  rounded-lg bg-white shadow-xl transition-all">
                    <div class="cabeceraModalModificar flex flex-row justify-between">
                        ...
                        <svg class="hoverX" id="ocultarModificarCancelarComercial" width="55" height="55"
                    ...
                    <div class="flex flex-col cajaSeccionesModalMod">
                        <div class="flex">
                            <h5 class="seccionesModalModificar">Datos personales:</h5>
                        </div>
                        <div class="flex flex-row">
                        ...
                        <div class="flex flex-row mt-4">
                            <div class="flex flex-col">
                                <div class="flex">
                                    <label class="labelsModal" for="">DNI/NIE:</label>
                                </div>
                                <input type="text" id="searchInput"
                                    class="tamanyoInputMedioModales mr-5 w-full p-2 pr-10 border rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500"
                                    placeholder="DNI/NIE" />
                    ...
                    <div class="flex flex-row">
                        <div class="flex flex-col cajaSeccionesModalMod">
                            <div class="flex">
                                <h5 class="seccionesModalModificar">Información de acceso:</h5>
                            </div>
                            <div class="flex flex-row">
                                <div class="flex flex-col">
                                    <input type="text" id="searchInput"
                        ...
                        <div class="flex flex-col cajaSeccionesModalMod">
                            <div class="flex">
                                <h5 class="seccionesModalModificar">Zona asignada:</h5>
                            </div>
                            <div class="flex flex-row">
                                <div class="flex flex-col">
                                    <input type="text" id="searchInput"
                    ...
                    <div class="flex flex-row mt-4">
                        <button id="mostrarModalConfirmacionGuardarComercial"
                            class="botonEliminar margen-boton-guardar-comercial">Guardar<svg width="24"
                                ...
                                <path
                                    ...
                                    stroke="white" stroke-width="2.1" stroke-miterlimit="10" stroke-linecap="round"
                                    stroke-linejoin="round" />
                                <path
    ...
    <div id="modalConfirmacionGuardarCambiosComercial" class="fixed inset-0 z-10 hidden"
            ...
            <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                <div
                    ...
                    <div class="cajaTxt mt-4">
                        ...
                        <h4 class="infoConfi">La siguiente acción modificará los datos del comercial.</h4>
                    </div>
                    <div class=" btnCaja flex flex-row">
                        <button id="cancelarModalConfirmacionGuardarComercial"
                            class="cancelConfi w-[50%]">Cancelar</button>
                        <button id="confirmarModalConfirmacionGuardarComercial"
                            class="confirmConfi w-[50%]">Confirmar</button>
                    </div>
                </div>
            </div>
    ...
    {{-- Modal añadir --}}
    <div id="modalAnyadirComercial" class="fixed inset-0 z-10 hidden" aria-labelledby="modal-title" role="dialog"
        aria-modal="true">
        <!-- Fondo oscuro -->
        <div class="fixed inset-0 bg-black/50 transition-opacity blur-effect"></div>
        <!-- Contenedor del modal -->
            ...
            <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                ...
                <div
                    ...
                    <div class="cabeceraModalModificar flex flex-row justify-between">
                        ...
                        <svg class="hoverX" id="ocultarAnyadirCancelarComercial" width="55" height="55"
                            viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M21 21L12 12M12 12L3 3M12 12L21.0001 3M12 12L3 21.0001" stroke="#90242A"
                                stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                    ...
                    <div class="flex flex-row mt-4">
                        <button id="mostrarModalConfirmacionAnyadirComercial"
                            class="botonAnyadirComercial margen-boton-anyadir-comercial">Añadir comercial<svg width="26"
                            height="28" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M4.5 9.69531H13.5" stroke="white" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path d="M9 14.4697V4.92969" stroke="white" stroke-width="2" stroke-linecap="round"
    ...
    <div id="modalConfirmacionAnyadirComercial" class="fixed inset-0 z-10 hidden" aria-labelledby="modal-title"
        role="dialog" aria-modal="true">
        <!-- Fondo oscuro -->
        <div class="fixed inset-0 bg-black/50 transition-opacity blur-effect"></div>
        <!-- Contenedor del modal -->
            ...
            <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                <div
                    ...
                    <div class="cajaTxt mt-4">
                        ...
                        <h4 class="infoConfi">La siguiente acción creará un nuevo comercial y un usuario para iniciar sesión.</h4>
                    </div>
                    <div class=" btnCaja flex flex-row">
                        <button id="cancelarModalConfirmacionAnyadirComercial"
                            class="cancelConfi w-[50%]">Cancelar</button>
                        <button id="confirmarModalConfirmacionAnyadirComercial"
                            class="confirmConfi w-[50%]">Confirmar</button>
                    </div>
                </div>
            </div>
    ...
    {{-- CRUD Modales Administrativos --}}
    <!-- Modal (inicialmente oculto) -->
    <div id="modalConfirmacionEliminarAdministrativo" class="fixed inset-0 z-10 hidden" aria-labelledby="modal-title"
        role="dialog" aria-modal="true">
        <!-- Fondo oscuro -->
        <div class="fixed inset-0 bg-black/50 transition-opacity blur-effect"></div>
        ...
        <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
            <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                <div
                    ...
                    <div class="cajaTxt mt-4">
                        <h3 class="cabeceraConfi m-4">¿Estás seguro que quieres deshabilitarlo?</h3>
                        <h4 class="infoConfi">La siguiente acción deshabilitará al administrativo pero no borrará sus datos.
                        </h4>
                    </div>
                    <div class=" btnCaja flex flex-row">
                        <button id="ocultarConfirmacionCancelarAdministrativo"
                            class="cancelConfi w-[50%]">Cancelar</button>
                        <button id="ocultarConfirmacionConfirmarAdministrativo"
                            class="confirmConfi w-[50%]">Confirmar</button>
                    </div>
                </div>
            </div>
    ...
    {{-- Modal modificar --}}
    <div id="modalModificarAdministrativo" class="fixed inset-0 z-10 hidden" aria-labelledby="modal-title" role="dialog"
        aria-modal="true">
        <!-- Fondo oscuro -->
        <div class="fixed inset-0 bg-black/50 transition-opacity blur-effect"></div>
        <!-- Contenedor del modal -->
            ...
            <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                ...
                <div
                    ...
                    <div class="cabeceraModalModificar flex flex-row justify-between">
                        ...
                        <svg class="hoverX" id="ocultarModificarCancelarAdministrativo" width="55" height="55"
                            viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M21 21L12 12M12 12L3 3M12 12L21.0001 3M12 12L3 21.0001" stroke="#90242A"
                                stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                    ...
                    <div class="flex flex-row">
                        ...
                        <div class="flex flex-col cajaSeccionesModalMod">
                            <div class="flex">
                                <h5 class="seccionesModalModificar">Departamento:</h5>
                            </div>
                            <div class="flex flex-row">
                                <div class="flex flex-col">
                                    <input type="text" id="searchInput"
                    ...
                    <div class="flex flex-row mt-4">
                        <button id="mostrarModalConfirmacionGuardarAdministrativo"
                            class="botonEliminar margen-boton-guardar-comercial">Guardar<svg width="24"
                                height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M9.30957 14.3947L10.8096 15.8174L14.8096 12.0234" stroke="white"
    ...
    {{-- Modal confirmacion guardar --}}
    <div id="modalConfirmacionGuardarCambiosAdministrativo" class="fixed inset-0 z-10 hidden"
        aria-labelledby="modal-title" role="dialog" aria-modal="true">
        <!-- Fondo oscuro -->
        <div class="fixed inset-0 bg-black/50 transition-opacity blur-effect"></div>
        <!-- Contenedor del modal -->
        <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
            <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                <div
                    ...
                    <div class="cajaTxt mt-4">
                        <h3 class="cabeceraConfi m-4">¿Estás seguro que quieres modificarlo?</h3>
                        <h4 class="infoConfi">La siguiente acción modificará los datos del administrativo.</h4>
                    </div>
                    <div class=" btnCaja flex flex-row">
                        <button id="cancelarModalConfirmacionGuardarAdministrativo"
                            class="cancelConfi w-[50%]">Cancelar</button>
                        <button id="confirmarModalConfirmacionGuardarAdministrativo"
                            class="confirmConfi w-[50%]">Confirmar</button>
                    </div>
                </div>
            </div>
    ...
    {{-- Modal añadir --}}
    <div id="modalAnyadirAdministrativo" class="fixed inset-0 z-10 hidden" aria-labelledby="modal-title" role="dialog"
        aria-modal="true">
        <!-- Fondo oscuro -->
        <div id="estiloOpacidad" class="fixed inset-0 bg-black/50 transition-opacity"></div>
        <!-- Contenedor del modal -->
        <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
            <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                {{-- Este div de abajo hay que convertirlo en un form con method post --}}
                <div
                    ...
                    <div class="cabeceraModalModificar flex flex-row justify-between">
                        ...
                        <svg class="hoverX" id="ocultarAnyadirCancelarAdministrativo" width="55" height="55"
                            viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M21 21L12 12M12 12L3 3M12 12L21.0001 3M12 12L3 21.0001" stroke="#90242A"
                                stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                    ...
                    <div class="flex flex-row mt-4">
                        <button id="mostrarModalConfirmacionAnyadirAdministrativo"
                            class="botonAnyadirComercial margen-boton-anyadir-administrativo">Añadir administrativo<svg width="26"
                            height="28" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M4.5 9.69531H13.5" stroke="white" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path d="M9 14.4697V4.92969" stroke="white" stroke-width="2" stroke-linecap="round"
    ...
    {{-- Modal confirmacion añadir --}}
    <div id="modalConfirmacionAnyadirAdministrativo" class="fixed inset-0 z-10 hidden" aria-labelledby="modal-title"
        role="dialog" aria-modal="true">
        <!-- Fondo oscuro -->
        <div class="fixed inset-0 bg-black/50 transition-opacity blur-effect "></div>
        <!-- Contenedor del modal -->
        <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
            <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                <div
                    ...
                    <div class="cajaTxt mt-4">
                        <h3 class="cabeceraConfi m-4">¿Estás seguro que quieres registrarlo?</h3>
                        <h4 class="infoConfi">La siguiente acción creará un nuevo usuario administrativo.</h4>
                    </div>
                    <div class=" btnCaja flex flex-row">
                        <button id="cancelarModalConfirmacionAnyadirAdministrativo"
                            class="cancelConfi w-[50%]">Cancelar</button>
                        <button id="confirmarModalConfirmacionAnyadirAdministrativo"
                            class="confirmConfi w-[50%]">Confirmar</button>
                    </div>
                </div>
            </div>
