    ...
    <div class="menu-administrativo flex">
        <div class="menu-pequenyo-administrativo flex flex-col" id="menu-pequenyo-administrativo">
          ...
          <div class="iconos-menu-administrativo flex flex-col ml-4">
            ...
            <!--Productos icono-->
            <svg class="iconosM" width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M3.43457 8.0625L13.0004 13.5983L22.5012 8.095" stroke="white" stroke-width="1.5" stroke-linecap="round"
                stroke-linejoin="round" />
            ...
            <svg class="iconosM" width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path
                ...
                stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
              <path d="M18.4166 14.347V10.382L8.13574 4.44531" stroke="white" stroke-width="1.5" stroke-linecap="round"
                stroke-linejoin="round" />
            </svg>
            <!--Descuentos icono-->
            <svg class="iconosM" width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="menu-grande-administrativo" id="menu-grande-administrativo">
          ...
          <div class="div-menu-grande-administrativo">
            ...
            <a href="/usuariosAdministrativo" class="boton-menu-sel-administrativo" routerLink="catalogosAdministrativo">Usuarios</a>
        ...
        <div class="flex flex-col">
            ...
            <div class="navegacion-diferentes-usuarios">
                <div class="contenedor-navegacion-usuarios flex flex-row">
                    <button id="boton-efecto-active-cVIP" class="botones-navegacion-usuarios boton-navegacion-usuario-active flex flex-col">Clientes VIP<span class="linea-blanca"></span><span id="linea-roja-vip" class="linea-roja-cVIP"></span></button>
                    <button id="boton-efecto-active-comercial" class="botones-navegacion-usuarios boton-navegacion-usuario-active flex flex-col">Comerciales<span class="linea-blanca"></span><span id="linea-roja-comer" class="linea-roja-comerciales"></span></button>
                    <button id="boton-efecto-active-administrativo" class="botones-navegacion-usuarios boton-navegacion-usuario-active flex flex-col">Administrativos<span class="linea-blanca-grande"></span><span id="linea-roja-admin" class="linea-roja-administrativos"></span></button>
                </div>
            </div>
