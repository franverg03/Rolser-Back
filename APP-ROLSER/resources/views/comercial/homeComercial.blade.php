...
<body class="contenedor">
    <div class="menu-comercial flex">
        <div class="menu-pequenyo-comercial flex flex-col" id="menu-pequenyo-administrativo">
          <img class="mt-3 mb-1 ml-1 logo-pequenyo-comercial" width="40vh"
            src="./images/logoPequenyoRolser.png" alt="">
            <svg class="icono-cliente-comercial" width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M7 35C7 29.75 14 29.75 17.5 26.25C19.25 24.5 14 24.5 14 15.75C14 9.91725 16.3328 7 21 7C25.6673 7 28 9.91725 28 15.75C28 24.5 22.75 24.5 24.5 26.25C28 29.75 35 29.75 35 35" stroke="white" stroke-width="1.5" stroke-linecap="round"/>
              </svg>
          <div class="iconos-menu-comercial flex flex-col ml-3">
            ...
            {{-- Facturas icono --}}
            <svg class="iconosM" width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M23.4626 11.31L22.4009 15.8384C21.4909 19.7492 19.6926 21.3309 16.3126 21.0059C15.7709 20.9625 15.1859 20.8651 14.5576 20.7134L12.7376 20.28C8.22009 19.2075 6.82259 16.9759 7.88426 12.4476L8.94592 7.90838C9.16259 6.98755 9.42259 6.18588 9.74759 5.52505C11.0151 2.90338 13.1709 2.19922 16.7893 3.05505L18.5984 3.47755C23.1376 4.53922 24.5243 6.78172 23.4626 11.31Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M16.312 21.0057C15.6403 21.4607 14.7953 21.8399 13.7661 22.1757L12.0545 22.7391C7.75362 24.1257 5.48945 22.9666 4.09195 18.6657L2.70528 14.3866C1.31862 10.0857 2.46695 7.81074 6.76778 6.42407L8.47945 5.86074C8.92362 5.7199 9.34612 5.60074 9.74695 5.5249C9.42195 6.18574 9.16195 6.9874 8.94529 7.90824L7.88362 12.4474C6.82195 16.9757 8.21945 19.2074 12.737 20.2799L14.557 20.7132C15.1853 20.8649 15.7703 20.9624 16.312 21.0057Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M13.6953 9.24072L18.9495 10.5732" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M12.6328 13.4333L15.7745 14.235" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
            <!--Pedidos icono-->
            <svg class="iconosM" width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
          ...
          <div class="iconos-usuario-logout-comercial">
            <img width="35px" class="imagen-usuario-comercial" src="/images/administrativoDani.png" alt="">
            <!--LogOut icono-->
        ...
        <div class="menu-grande-comercial d-flex flex-col" id="menu-grande-administrativo">
          ...
          <div class="div-menu-grande-comercial">
            ...
            <a href="/clientesComercial" class="boton-menu-noSel-comercial" routerLink="clientesComercial">Clientes</a>
            <a href="/catalogosComercial" class="boton-menu-noSel-comercial" routerLink="catalogosComercial">Catálogos</a>
            <a href="/facturasComercial" class="boton-menu-noSel-comercial" routerLink="facturasComercial">Facturas</a>
            <a href="/pedidosComercial" class="boton-menu-noSel-comercial" routerLink="pedidosComercial">Pedidos</a>
          </div>
