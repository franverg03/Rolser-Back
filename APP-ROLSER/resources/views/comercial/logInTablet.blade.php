...
<head>
    ...
    <link rel="stylesheet" href="/styles/logInTablet.css">
    <title>LogInRolser</title>
</head>
<body class="containerP">
    <form class="form" action="" method="post">
        <img class="logoRolserP" src="/images/logoPequenyoRolser.png" alt="logoRolserPequeño">
        <img src="/images/logoGrandeRolser.png" alt="logoRolserGrande">
        <div class="contenedorInputs">
            <div class="rectoInput">
                ...
                <input class="inputU" type="text" placeholder="Usuario">
            </div>
            <div class="rectoInput">
                <svg width="32" height="32" viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <input class="inputU" type="password" placeholder="Contraseña">
            </div>
        </div>
        <a class="mpOlvidada" href="">¿Has olvidado la contraseña?</a>
