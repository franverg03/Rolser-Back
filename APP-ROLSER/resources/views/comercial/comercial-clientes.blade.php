                                ...
                                <div
                                    ...
                                    <div class="flex flex-col cajaSeccionesModalMod">
                                        ...
                                        <div class="flex flex-row">
                                            ...
                                            <div class="flex flex-col">
                                                <label for="cp" class="labelsModal">CP:</label>
                                                <input type="text" id="codigoPostal" name="codigoPostal"
                                                class="tamanyoInputPequenyoModales w-full p-2 pr-10 border rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500"
                                                placeholder="CP" />
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
                            <div
                                ...
                                <div
                                    ...
                                    <div class="btnCaja flex flex-row">
                                        <button id="cancelarModalConfirmacionGuardarCNoVip" type="button"
                                            class="cancelConfi w-[50%]">
                                            Cancelar
                                        </button>
                                        <button id="confirmarModalConfirmacionGuardarCNoVip" type="submit"
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div class="cajaTxt mt-4">
                                        ...
                                        <h4 class="infoConfi">La siguiente acción creará un nuevo cliente VIP y un
                                            usuario
                                            para
                                            iniciar sesión.</h4>
                                    </div>
